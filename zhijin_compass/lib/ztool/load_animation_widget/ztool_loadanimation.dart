...
import 'package:zhijin_compass/ztool/ztool_screen.dart';
...
class FlashAnimation extends StatefulWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(
      EnumProperty<FlashAnimationDirection>('direction', direction),
    );
    properties.add(
    ...
    properties.add(
      DiagnosticsProperty<bool>('enabled', animationStart, defaultValue: null),
    );
  }
}
