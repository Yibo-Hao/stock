...
class _CubeTransitionIndicatorState extends State<CubeTransitionIndicator>
  ...
  void initState() {
    ...
    ).animate(CurvedAnimation(parent: _controller, curve: Interval(0, 0.25)));
    transY = Tween<double>(
      begin: 0,
      end: end,
    ).animate(CurvedAnimation(parent: _controller, curve: Interval(0.25, 0.5)));
    transReverseX = Tween<double>(
      begin: 0,
      end: end,
    ).animate(CurvedAnimation(parent: _controller, curve: Interval(0.5, 0.75)));
    transReverseY = Tween<double>(
      begin: 0,
      end: end,
