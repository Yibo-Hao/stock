...
class _BallZigZagIndicatorState extends State<BallZigZagIndicator>
  ...
  void initState() {
    ...
    var waistLength = sqrt(
      pow(widget.width * .5 - widget.ballRadius, 2) +
    ...
    _horizontal = Tween<double>(begin: begin, end: end).animate(
      CurvedAnimation(parent: _controller, curve: Interval(0, horEndInterval)),
    );
    ...
    _leftWaistX = Tween<double>(begin: begin, end: end).animate(
      CurvedAnimation(
        parent: _controller,
    ...
    _leftWaistY = Tween<double>(begin: begin, end: end).animate(
      CurvedAnimation(
        parent: _controller,
        curve: Interval(rightEndInterval, leftEndInterval),
      ),
