...
class ZzToast {
  ...
  static void config() {
    ...
    EasyLoading.instance.errorWidget = Image(
      image: const AssetImage('assets/images/icon_error.png', package: "ztool"),
      width: 42.0.rpx,
      height: 42.0.rpx,
    );
    ...
    EasyLoading.instance.contentPadding = EdgeInsets.fromLTRB(
      15.0.rpx,
      10.0.rpx,
      15.0.rpx,
      10.0.rpx,
...
class OKToasting {
    ...
    toastFuture = showToastWidget(
      Container(
        ...
        child: Column(
          ...
          children: [
            // Container(width: 42.0.rpx, height: 42.0.rpx, child: widget),
            Text(
              msg,
  ...
  static void showOkSuccess(String msg, {Duration? duration}) {
    _showOkWidgetInfo(
      Image.asset('assets/images/icon_success.png', package: "ztool"),
      msg,
      duration: duration,
    );
  }
  ...
  static void showOkError(String msg, {Duration? duration}) {
    _showOkWidgetInfo(
      Image.asset('assets/images/icon_error.png', package: "ztool"),
      msg,
      duration: duration,
    );
  }
  ...
  static void showOKInfo(String msg, {Duration? duration}) {
    _showOkWidgetInfo(
      Icon(Icons.info_outline, color: Colors.white, size: 42.0.rpx),
      msg,
      duration: duration,
    );
  }
