...
//通用Refresh样式
MaterialClassicHeader smartHeader = MaterialClassicHeader(
          ...
          switch (status) {
            case LoadStatus.loading:
              return Container(
                ...
                child: Text("加载中...", style: ZzFonts.fontMedium666(14)),
              );
            case LoadStatus.noMore:
              return Container(
                padding: const EdgeInsets.only(top: 20),
                alignment: Alignment.bottomCenter,
                child: Text("已加载完毕", style: ZzFonts.fontMedium666(14)),
              );
            ...
            default:
              return Container(
                padding: const EdgeInsets.only(top: 20),
                alignment: Alignment.bottomCenter,
                child: Text("向上滑动加载更多", style: ZzFonts.fontMedium666(14)),
              );
          }
        },
      ),
