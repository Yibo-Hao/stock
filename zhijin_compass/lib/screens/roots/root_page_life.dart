...
class PageLifeCycleObserver extends WidgetsBindingObserver {
  ...
  // 生命周期监控
  final List<PageLifeCycle> _observers = [];
  // 缓存上一次的app状态
  ...
  //保存单例
  static final PageLifeCycleObserver _singleton =
      PageLifeCycleObserver._internal();
  ...
  void addPageLifeCycleObserver(PageLifeCycle observer, ModalRoute route) {
